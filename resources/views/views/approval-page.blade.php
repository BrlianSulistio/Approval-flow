    ...
    <div class="col-lg-5 col-md-8 col-sm-12">
      <div class="d-flex flex-row mb-3">
        ...
        <ul class="breadcrumb">
          ...
          <li class="p-1 text-primary">Approval Page</li>
        </ul>
      </div>
        ...
        <div class="card ">
          <div class="body table-responsive p-0 py-2">
            <div class="d-flex justify-content-between align-items-center  mx-0">
              <div class="p-2">
                <h6>Data Need Approval</h6>
              </div>
            </div>
            @csrf
            <table class="table p-0 table-hover table-striped js-basic-example dataTable table-custom display responsive" style="width: 100%;" id="table-needs-approval">
              <thead>
                <tr>
                  ...
                  <th class="text-center" style="width: 20%">Approval</th>
                  <th class="text-center" style="width: 15%">Diajukan Oleh</th>
                </tr>
              </thead>
            </table>
          </div>
...
<script src="{{ URL::asset('assets/js/subjs/approval-page.js') }}" type="text/javascript"></script>
@endpush