    ...
    <div class="col-lg-5 col-md-8 col-sm-12">
      <div class="d-flex flex-row ">
        ...
        <ul class="breadcrumb">
          ...
          <li class="p-1 text-primary">Tambah Transaksi</li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="container-fluid">
  ...
  <div class="d-flex justify-content-between align-items-center my-2 mx-0">
    <div class="">
      <h6 class="text-dark p-0 ">Form Transaksi</h6>
  ...
  <div class="row clearfix section-divider">
    <div class="col-lg-4">
      <h6 class="text-dark ">Input Form Transaksi</h6>
    </div>
  ...
  <div class="row clearfix section-divider d-none" id="data-approval">
    ...
    <div class="col-lg-8 form">
      <div class="row p-0 con-approval">
...
<script src="{{ URL::asset('assets/js/subjs/form-transaksi.js') }}" type="text/javascript"></script>
@endpush